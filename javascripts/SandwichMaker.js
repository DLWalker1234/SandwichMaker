// Create a sandwich order form that allows the user 
// to select all the ingredients for a custom deli sandwich.
//  Create a Sandwich module, then create the following 
//  as individual modules, using IIFE syntax, to augment Sandwich:
...
// An empty DOM element into which the final sandwich order 
// and its cost will be inserted
// The ingredient choices should be stored as JS objects 
// that contain the ingredients as keys and their cost as the value. {"turkey": 0.90, "bacon": 1.50}

// Make sure the ingredient objects cannot be accessed 
